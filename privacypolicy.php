...
?>
 <div class="center">
    <h1>Privacy Policy for FlippWheels</h1>
    <p>
        At flipwheels.com, accessible from www.Flippwheels/webpage.html, 
        one of our main priorities is the privacy of our visitors. 
        This Privacy Policy document contains types of information that 
        is collected and recorded by flipwheels.com and how we use it.
        If you have additional questions or require more information about our Privacy Policy, 
        do not hesitate to contact us.
        This Privacy Policy applies only to our online activities and is valid for visitors 
        to our website with regards to the information that they shared and/or collect in flipwheels.
        com. This policy is not applicable to any information collected offline or via channels 
        other than this website. Our Privacy Policy was created with the help of the TermsFeed 
    ...
    <h2>Log Files</h2>
    <p>
        flipwheels.com follows a standard procedure of using log files. These files log visitors when they visit websites. 
    ...
    <p>
        Like any other website, flipwheels.com uses 'cookies'. These cookies are used to store information including 
        ...
        information. For more general information on cookies, please read "Cookies" article from the Privacy Policy Generator.
    </p>
    ...
    <ul style="list-style-type:circle">
        ...
        <li>You may consult this list to find the Privacy Policy for each of the advertising partners of flipwheels.com.</li>
        <li>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on flipwheels.com, which are sent directly to users' browser.
        ...
        <li>Note that flipwheels.com has no access to or control over these cookies that are used by third-party advertisers.</li>
    </ul>
    <h2>Third Party Privacy Policies</h2>
    <p>
        flipwheels.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult 
    ...
    <p>
        ...
        flipwheels.com does not knowingly collect any Personal Identifiable Information from children under the age of 13. 
